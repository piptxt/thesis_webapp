        ...
        <div className="flex">
          ...
          <hr className="font-semibold mb-3"></hr>
            <label className="block mb-1">
              ...
              {/* Tooltip for brief explanation */}
              {/* {showTooltip && (
                <div className="absolute bg-white p-2 border rounded shadow-md mt-1 w-64">
                  <p className="text-sm">
                  Search scores indicate the relevance of a document based on how closely it matches your query, both in terms of exact words and overall meaning.
                  </p>
                </div>
              )} */}
            </label>
